#%%
# Merge monthly WOA18 Nitrate and subset to 0-200m
...
sample_ds = xr.open_dataset(base_path + "woa18_all_n01_01.nc", decode_times=False,
...
for i in range(0, 12):
    ...
    ds = xr.open_dataset(base_path + "woa18_all_n" + files[i] + "_01.nc",
...
df.set_index(['time', 'depth', 'lat', 'lon'], inplace=True)
ds = df.to_xarray().to_netcdf("/home/mv23682/Documents/Abil/studies/wiseman2024/env_data_processing/regridded_data/no3.nc")
