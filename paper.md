...
Beyond scikit-learn, Abil leverages libraries like Xarray [@ref], Pandas [@ref], and Numpy [@ref] for efficient data manipulation, as well as scikit-bio [@ref] for biodiversity metrics. 
